...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "cv",
          description: "Brief summary of me.",
          section: "Navigation",
          handler: () => {
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/derivations/";
          },
      ...
      handler: () => {
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-the-chemistry-of-clinker",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/gp/";
            },},{id: "projects-on-site-insight-is-crucial-when-building-ai-models",
          title: 'On site insight is crucial when building AI models',
          description: "Visiting a cement plant in the Peak District",
          section: "Projects",handler: () => {
              window.location.href = "/projects/insights/";
            },},{id: "projects-kolmogorov-arnold-networks-simply-explained",
          title: 'Kolmogorov-Arnold Networks, simply explained',
          description: "The latest advance in neural networks, simply explained",
          section: "Projects",handler: () => {
              window.location.href = "/projects/kan/";
            },},{id: "projects-climate-change-and-ai-in-new-orleans",
          title: 'Climate Change and AI in New Orleans',
          description: "Reflections on NeurIPS 2023",
          section: "Projects",handler: () => {
              window.location.href = "/projects/neurips/";
            },},{id: "projects-physics-informed-neural-networks-with-pytorch",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%74%68%65%6F@%72%6F%62%6F%74%73.%6F%78.%61%63.%75%6B", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/TheodoreWolf", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/theo-wolf", "_blank");
        },
      },{
        id: 'social-medium',
        title: 'Medium',
        section: 'Socials',
        handler: () => {
          window.open("https://medium.com/@theo.wolf", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=TRAhumoAAAAJ", "_blank");
        },
      },{
        id: 'social-x',
        title: 'X',
        section: 'Socials',
        handler: () => {
          window.open("https://twitter.com/TheoW0lf", "_blank");
        },
      },{
      id: 'light-theme',
